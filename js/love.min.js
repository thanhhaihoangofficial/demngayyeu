...
Flowtime.showProgress(!0), Flowtime.addEventListener("flowtimenavigation", onNavigation, !1), Flowtime.start(), $(function() {
    ...
    with(sharedesc = $("#text-1").text() + $("#text-2").text() + $("#text-3").text() + $("#text-4").text() + $("#text-5").text() + $("#text-6").text() + $("#text-7").text() + $("#text-8").text() + "......", shareurl = $("#write-url u").eq(0).text(), window._bd_share_config = {
        common: {
            bdSnsKey: {},
            bdText: sharetext,
            bdDesc: sharedesc,
            ...
            bdPic: "https://res.zhangge.net/love/img/319280.jpg",
            bdStyle: "1",
            bdSize: "32"
        },
        share: {}
    }, document) 0[(getElementsByTagName("head")[0] || body).appendChild(createElement("script")).src = "https://dn-zgboke.qbox.me/static/bdshare.js?v=89860593.js?cdnversion=" + ~(-new Date / 36e5)]
});